...
Get up and running with Join in minutes.

**Learn how to:**

* Install dependencies
* Build and configure the framework
...
Explore the framework's modular architecture.
...
Join is released under the [MIT License](https://github.com/joinframework/join/blob/main/LICENSE).
